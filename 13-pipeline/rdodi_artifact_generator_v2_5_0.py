#!/usr/bin/env python3
"""RDODI Artifact Generator v2.5.0 — domain-general + profile-driven.

Supersedes the SCP-hardcoded rdodi_html_generator_v1_0_0 (which fell back to the SCP namespace and
read scp:example/scp:hasVisual). v2.5.0:
...
# ================= v2.5.0 ADDITION: profile-driven PAGE generation (A3-page) =================
...
def generate_page(domain_ttl, profiles_ttl, profile, doc_abox_ttl, out_dir):
    ...
    out.add((surface, IP.genre, Literal(genre)))   # v2.5.0: page declares its genre (profile-driven, renderer-readable)
