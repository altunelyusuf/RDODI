#!/usr/bin/env python3
"""RDODI Artifact Generator v2.4.0 — domain-general + profile-driven.

Supersedes the SCP-hardcoded rdodi_html_generator_v1_0_0 (which fell back to the SCP namespace and
read scp:example/scp:hasVisual). v2.4.0:
...
# ================= v2.4.0 ADDITION: profile-driven PAGE generation (A3-page) =================
